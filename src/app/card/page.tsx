      ...
      >
        ...
        <div className="md:w-1/2 w-full p-6 md:p-0">
          <div className="flex flex-col gap-4 text-white">
            ...
            <div
              className="bg-white flex flex-row p-6 rounded-3xl
            ...
            >
              ...
              <div className="flex flex-col gap-5 flex-grow pl-4 md:pl-6 text-lg">
                <p>{user.name || "Nome e Sobrenome"}</p>
                <p>{user.phone || "00 00000-0000"}</p>
          ...
          >
            <Image src={ArrowDown} alt="Arrow" height={30} width={30} />
            BAIXAR CARTÃO
          </button>
          <a
            href="https://app.rdstation.com.br/signup"
            className="flex flex-row pt-8 text-white gap-2"
          >
            <h1>FAZER UM TESTE GRÁTIS DO RD STATION MARKETING</h1>
            <Image src={ArrowR} alt="Arrow" height={20} width={20} />
          </a>
        </div>
      </div>
    </div>
